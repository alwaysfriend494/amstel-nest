...
const Profile = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Verified host" role="img" focusable="false" style={{display: 'block', height: '16px', width: '16px', fill: 'white'}}>
