  ...
  return (
    <section className="mt-6 w-full">
      <div className="w-full h-20 flex justify-between items-center">
        <div className="w-[80%]">
          <p className="text-2xl font-semibold">Room in Watergraafsmeer, Netherlands</p>
          <p className="text-base">1 double bed Private attached bathroom</p>
        </div>
      </div>
      <div className="w-full h-20 p-[22px_26px] rounded-xl border-[#ddd] border-[1px] flex justify-between items-center cursor-pointer">
        <div className="w-[75%] flex justify-between items-center">
          <div className="w-[30%] flex justify-between items-center">
            ...
            <div className="px-[4px] pb-[4px] text-center font-[700] leading-5 text-[1.125rem]">
              <p>Guest favorite</p>
            </div>
            <div className="w-auto h-9">
          ...
          <div className="w-[65%] pb-[3px] leading-5 text-[1rem]">
        ...
        <div className="bg-[#ddd] h-[40px] w-[1px]"></div>
        <div className="w-[8%] flex flex-col items-centers">
          <span className="text-2xl">558</span>
          <span className="underline text-xs font-medium">Reviews</span>
        </div>
      </div>
      <div className="w-full border-b-[1px]">
        <div className="py-[24px]">
          <div className="w-full flex items-center gap-6 h-10">
            <div className="h-full relative">
              <div className="h-full relative">
                <img src={Family} alt="" className="w-10 h-full object-cover rounded-[50%]" />
            ...
            <div className="w-[45%] flex flex-col gap-1">
              <div className="font-medium text-[1rem]">Hosted by Rob & Fang</div>
              <div className="w-[60%] flex justify-between items-center">
                <span>Superhost</span>
                <div className="w-[3px] h-[3px] rounded-[50%] bg-gray-700"></div>
      ...
      <div className="w-full border-b-[1px]">
        <div className="py-[24px] gap-6 flex flex-col justify-between">
          <div className="w-full flex items-center gap-6 h-10">
            ...
            <div className="flex flex-col gap-1">
              <div className="font-medium text-[1rem]">Room in a townhouse</div>
          ...
          <div className="w-full flex items-center gap-6 h-10">
            ...
            <div className="flex flex-col gap-1">
              <div className="font-medium text-[1rem]">Shared common spaces</div>
              <div className="flex justify-between items-center">
                <span>You'll share parts of the home.</span>
              </div>
            </div>
          </div>
          <div className="w-full flex items-center gap-6 h-10">
            ...
            <div className="flex flex-col gap-1">
              <div className="font-medium text-[1rem]">Private attached bathroom</div>
              <div className="flex justify-between items-center">
                <span>This place has a bathroom that’s connected to your room.</span>
              </div>
            </div>
          </div>
          <div className="w-full flex items-center gap-6 h-10">
            ...
            <div className="flex flex-col gap-1">
              <div className="font-medium text-[1rem]">Self check-in</div>
              <div className="flex justify-between items-center">
