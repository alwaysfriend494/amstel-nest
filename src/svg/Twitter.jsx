...
const Twitter = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Navigate to Twitter" role="img" focusable="false" style={{display: 'block', height: '18px', width: '18px', fill: 'currentcolor'}}>
